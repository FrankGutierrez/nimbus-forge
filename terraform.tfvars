...
# elastic_package_registry_image = "docker.elastic.co/package-registry/distribution:8.13.1"
...
# eck_operator_image = "docker.elastic.co/eck/eck-operator:2.12.1"
...
# elasticsearch_image = "docker.elastic.co/elasticsearch/elasticsearch:8.13.1"
elasticsearch_ingress_hostname = "es.k8s.internal"
elasticsearch_node_count = 1

##### Kibana Settings #####
# kibana_name = "kibana-sample"
# kibana_image = "docker.elastic.co/kibana/kibana:8.13.1"
