resource "kubectl_manifest" "eck-agents_agent_k8s_elastic_co" {
  yaml_body = <<YAML
...
resource "kubectl_manifest" "eck-apmservers_apm_k8s_elastic_co" {
  depends_on = [kubectl_manifest.eck-agents_agent_k8s_elastic_co]
  yaml_body = <<YAML
# Source: eck-operator-crds/templates/all-crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "eck-beats_beat_k8s_elastic_co" {
  depends_on = [kubectl_manifest.eck-apmservers_apm_k8s_elastic_co]
  yaml_body = <<YAML
# Source: eck-operator-crds/templates/all-crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "eck-elasticmapsservers_maps_k8s_elastic_co" {
  depends_on = [kubectl_manifest.eck-beats_beat_k8s_elastic_co]
  yaml_body = <<YAML
# Source: eck-operator-crds/templates/all-crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "eck-elasticsearchautoscalers_autoscaling_k8s_elastic_co" {
  depends_on = [kubectl_manifest.eck-elasticmapsservers_maps_k8s_elastic_co]
  yaml_body = <<YAML
# Source: eck-operator-crds/templates/all-crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "eck-elasticsearches_elasticsearch_k8s_elastic_co" {
  depends_on = [kubectl_manifest.eck-elasticsearchautoscalers_autoscaling_k8s_elastic_co]
  yaml_body = <<YAML
# Source: eck-operator-crds/templates/all-crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "eck-enterprisesearches_enterprisesearch_k8s_elastic_co" {
  depends_on = [kubectl_manifest.eck-elasticsearches_elasticsearch_k8s_elastic_co]
  yaml_body = <<YAML
# Source: eck-operator-crds/templates/all-crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "eck-kibanas_kibana_k8s_elastic_co" {
  depends_on = [kubectl_manifest.eck-enterprisesearches_enterprisesearch_k8s_elastic_co]
  yaml_body = <<YAML
# Source: eck-operator-crds/templates/all-crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "eck-logstashes_logstash_k8s_elastic_co" {
  depends_on = [kubectl_manifest.eck-kibanas_kibana_k8s_elastic_co]
  yaml_body = <<YAML
# Source: eck-operator-crds/templates/all-crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
...
resource "kubectl_manifest" "eck-stackconfigpolicies_stackconfigpolicy_k8s_elastic_co" {
  depends_on = [kubectl_manifest.eck-logstashes_logstash_k8s_elastic_co]
  yaml_body = <<YAML
# Source: eck-operator-crds/templates/all-crds.yaml
apiVersion: apiextensions.k8s.io/v1
kind: CustomResourceDefinition
              ...
              details:
                additionalProperties:
                  additionalProperties:
                    ...
                    properties:
                      currentVersion:
                        description: CurrentVersion denotes the current version of filesettings applied to the Elasticsearch cluster This field does not apply to Kibana resources
                        format: int64
                        type: integer
                      error:
                        properties:
                        ...
                        type: object
                      expectedVersion:
                        description: ExpectedVersion denotes the expected version of filesettings that should be applied to the Elasticsearch cluster This field does not apply to Kibana resources
                        format: int64
                        type: integer
                      phase:
                        type: string
                ...
                additionalProperties:
                  ...
                  properties:
                    ...
                    phase:
                      type: string
                  type: object
                description: 'ResourcesStatuses holds the status for each resource to be configured. Deprecated: Details is used to store the status of resources from ECK 2.11'
                type: object
            type: object
        type: object
    served: true
